...
public class AbstractDao extends CustomDaoSupport {
    ...
    public List<String> getProjectionData(String className, List<Filter> filters, List<Object> values,
                                          String projection) {
    ...
    public List<?> findAllData(String className, List<Filter> filters, List<Object> values, String pageNumber) {
        Session session = null;
        int count = 0;
        List<?> result = null;
        try {
