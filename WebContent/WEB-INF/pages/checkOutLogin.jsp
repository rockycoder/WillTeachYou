			...
			<div class="container">
				<div class="row">
						...
						<div id="user_login" class="form login ">
							...
							<div class="btn-group">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-12 col-lg-6" style="margin-bottom: 10px">
					...
					<div class="col-md-6">
						...
						<form method="post" action="checkOutRegisterUser"
							onsubmit="return userRegister()">
							<div id="user_registration" class="form login ">
								<label>Mobile<sup>*</sup></label><span id="mobilenoerror"
									class="errormessage"></span> <input type="text" name="mobile"
									class="input-text"> <label>Email <sup>*</sup></label> <span
									id="regemailerror" class="errormessage"></span> <input
									type="text" name="email" class="input-text"> <label>Password<sup>*</sup></label>
